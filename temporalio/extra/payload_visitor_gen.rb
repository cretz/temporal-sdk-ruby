...
class PayloadVisitorGen
  ...
  def gen_file_code
    ...
    <<~TEXT
      ...
      module Temporalio
        module Api
          # TODO(cretz): Doc that this is thread safe and that block may get a Payload, Payloads, or RepeatedField<Payload>
          # TODO(cretz): Doc that on enter/exit is not called for the payload/repeated itself
