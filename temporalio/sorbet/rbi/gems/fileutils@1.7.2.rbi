...
module FileUtils
  ...
  # source://fileutils//lib/fileutils.rb#1660
  ...
  #
  # source://fileutils//lib/fileutils.rb#238
  ...
  #
  # source://fileutils//lib/fileutils.rb#1896
  ...
  #
  # source://fileutils//lib/fileutils.rb#1912
  ...
  #
  # source://fileutils//lib/fileutils.rb#1507
  def cmp(a, b); end
  ...
  #
  # source://fileutils//lib/fileutils.rb#1530
  ...
  #
  # source://fileutils//lib/fileutils.rb#873
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # source://fileutils//lib/fileutils.rb#1040
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # source://fileutils//lib/fileutils.rb#1076
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # source://fileutils//lib/fileutils.rb#1088
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # source://fileutils//lib/fileutils.rb#627
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # source://fileutils//lib/fileutils.rb#985
  ...
  # source://fileutils//lib/fileutils.rb#2527
  def fu_clean_components(*comp); end

  # source://fileutils//lib/fileutils.rb#2466
  def fu_each_src_dest(src, dest); end

  # source://fileutils//lib/fileutils.rb#2474
  def fu_each_src_dest0(src, dest, target_directory = T.unsafe(nil)); end

  # source://fileutils//lib/fileutils.rb#1947
  def fu_get_gid(group); end

  # source://fileutils//lib/fileutils.rb#1933
  def fu_get_uid(user); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#1423
  def fu_have_symlink?; end

  # class Entry_
  #
  # source://fileutils//lib/fileutils.rb#2461
  def fu_list(arg); end

  # source://fileutils//lib/fileutils.rb#396
  def fu_mkdir(path, mode); end

  # source://fileutils//lib/fileutils.rb#1721
  def fu_mode(mode, path); end

  # source://fileutils//lib/fileutils.rb#2496
  def fu_output_message(msg); end

  # source://fileutils//lib/fileutils.rb#2518
  def fu_relative_components_from(target, base); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2491
  def fu_same?(a, b); end

  # source://fileutils//lib/fileutils.rb#2506
  def fu_split_path(path); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2550
  def fu_starting_path?(path); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#1432
  ...
  #
  # source://fileutils//lib/fileutils.rb#197
  def getwd; end
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # source://fileutils//lib/fileutils.rb#1609
  ...
  #
  # source://fileutils//lib/fileutils.rb#516
  ...
  #
  # source://fileutils//lib/fileutils.rb#812
  ...
  #
  # source://fileutils//lib/fileutils.rb#706
  ...
  #
  # source://fileutils//lib/fileutils.rb#724
  def ln_sf(src, dest, noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

  # Like FileUtils.ln_s, but create links relative to +dest+.
  #
  # source://fileutils//lib/fileutils.rb#731
  ...
  #
  # source://fileutils//lib/fileutils.rb#365
  ...
  #
  # source://fileutils//lib/fileutils.rb#316
  ...
  # source://fileutils//lib/fileutils.rb#1726
  ...
  #
  # source://fileutils//lib/fileutils.rb#1157
  ...
  #
  # source://fileutils//lib/fileutils.rb#1216
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#1492
  ...
  #
  # source://fileutils//lib/fileutils.rb#1449
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#1351
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#1473
  def remove_file(path, force = T.unsafe(nil)); end

  # source://fileutils//lib/fileutils.rb#276
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#1241
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#1299
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#1328
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # source://fileutils//lib/fileutils.rb#442
  ...
  # source://fileutils//lib/fileutils.rb#1672
  ...
  #
  # source://fileutils//lib/fileutils.rb#2006
  ...
  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#264
  def uptodate?(new, old_list); end

  # source://fileutils//lib/fileutils.rb#1642
  ...
  class << self
    ...
    #
    # source://fileutils//lib/fileutils.rb#2609
    ...
    #
    # source://fileutils//lib/fileutils.rb#2570
    def commands; end
    ...
    # @return [Boolean]
    #
    # source://fileutils//lib/fileutils.rb#2588
    ...
    #
    # source://fileutils//lib/fileutils.rb#2578
    def options; end
    ...
    #
    # source://fileutils//lib/fileutils.rb#2599
    def options_of(mid); end

    # source://fileutils//lib/fileutils.rb#185
...
#
# source://fileutils//lib/fileutils.rb#2676
module FileUtils::DryRun
  ...
  # source://fileutils//lib/fileutils.rb#2682
...
# source://fileutils//lib/fileutils.rb#2069
class FileUtils::Entry_
  include ::FileUtils::StreamUtils_

  # @return [Entry_] a new instance of Entry_
  #
  # source://fileutils//lib/fileutils.rb#2072
  def initialize(a, b = T.unsafe(nil), deref = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2138
  def blockdev?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2133
  def chardev?; end

  # source://fileutils//lib/fileutils.rb#2206
  def chmod(mode); end

  # source://fileutils//lib/fileutils.rb#2215
  def chown(uid, gid); end

  # source://fileutils//lib/fileutils.rb#2239
  def copy(dest); end

  # source://fileutils//lib/fileutils.rb#2277
  def copy_file(dest); end

  # source://fileutils//lib/fileutils.rb#2285
  def copy_metadata(path); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2105
  def dereference?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2123
  def directory?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2155
  def door?; end

  # source://fileutils//lib/fileutils.rb#2160
  def entries; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2109
  def exist?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2118
  def file?; end

  # source://fileutils//lib/fileutils.rb#2085
  def inspect; end

  # source://fileutils//lib/fileutils.rb#2223
  def link(dest); end

  # source://fileutils//lib/fileutils.rb#2192
  def lstat; end

  # source://fileutils//lib/fileutils.rb#2200
  def lstat!; end

  # source://fileutils//lib/fileutils.rb#2089
  def path; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2148
  def pipe?; end

  # source://fileutils//lib/fileutils.rb#2334
  def platform_support; end

  # @yield [_self]
  # @yieldparam _self [FileUtils::Entry_] the object that the method was called on
  #
  # source://fileutils//lib/fileutils.rb#2364
  def postorder_traverse; end

  # source://fileutils//lib/fileutils.rb#2097
  def prefix; end

  # source://fileutils//lib/fileutils.rb#2354
  def preorder_traverse; end

  # source://fileutils//lib/fileutils.rb#2101
  def rel; end

  # source://fileutils//lib/fileutils.rb#2314
  def remove; end

  # source://fileutils//lib/fileutils.rb#2322
  def remove_dir1; end

  # source://fileutils//lib/fileutils.rb#2328
  def remove_file; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2143
  def socket?; end

  # source://fileutils//lib/fileutils.rb#2170
  def stat; end

  # source://fileutils//lib/fileutils.rb#2180
  def stat!; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2128
  def symlink?; end

  # source://fileutils//lib/fileutils.rb#2354
  def traverse; end

  # source://fileutils//lib/fileutils.rb#2384
  ...
  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2406
  def check_have_lchmod?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2424
  def check_have_lchown?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2452
  def descendant_directory?(descendant, ascendant); end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2398
  def have_lchmod?; end

  # @return [Boolean]
  #
  # source://fileutils//lib/fileutils.rb#2416
  def have_lchown?; end

  # source://fileutils//lib/fileutils.rb#2432
  def join(dir, base); end
end

# source://fileutils//lib/fileutils.rb#2616
...
# to methods in FileUtils.
#
# source://fileutils//lib/fileutils.rb#2652
module FileUtils::NoWrite
  ...
  # source://fileutils//lib/fileutils.rb#2658
  def chmod(*args, **options); end
...
# source://fileutils//lib/fileutils.rb#2031
module FileUtils::StreamUtils_
  private

  # source://fileutils//lib/fileutils.rb#2054
  def fu_blksize(st); end

  # source://fileutils//lib/fileutils.rb#2041
  def fu_copy_stream0(src, dest, blksize = T.unsafe(nil)); end

  # source://fileutils//lib/fileutils.rb#2061
  def fu_default_blksize; end

  # source://fileutils//lib/fileutils.rb#2045
  def fu_stream_blksize(*streams); end

  # source://fileutils//lib/fileutils.rb#2038
  def fu_windows?; end
end
...
#
# source://fileutils//lib/fileutils.rb#2630
module FileUtils::Verbose
  ...
  # source://fileutils//lib/fileutils.rb#2635
