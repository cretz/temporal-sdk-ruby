...
module Temporalio
  ...
  module Workflow
    ...
    #
    # @param cancellation [Cancellation] Cancellation to cancel the wait. This defaults to the workflow's cancellation.
    ...
    class ContinueAsNewError < Error
      ...
      # @param task_queue [String] Task queue for the workflow. If unset/nil, the current workflow task queue is used.
