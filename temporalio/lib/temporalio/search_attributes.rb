...
module Temporalio
  ...
  class SearchAttributes
    ...
    # @!visibility private
    def self._from_proto(proto, disable_mutations: false)
      ...
      attrs = SearchAttributes.new(proto.indexed_fields.map do |key_name, payload| # rubocop:disable Style/MapToHash
